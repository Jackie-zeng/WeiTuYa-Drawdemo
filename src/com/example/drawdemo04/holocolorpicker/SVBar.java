...
public class SVBar extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		Log.i("mbarlength1",String.valueOf(mBarLength));
		...
		Log.i("mBarPointerHaloRadius",String.valueOf(mBarPointerHaloRadius));
		Log.i("mBarPointerPosition",String.valueOf(mBarPointerPosition));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Log.i("mbarlength",String.valueOf(mBarLength));
	}
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		Log.i("mcolor",String.valueOf(mColor));
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mOrientation == ORIENTATION_HORIZONTAL) {
			...
			Log.i("cx",String.valueOf(cX));
			Log.i("cy",String.valueOf(cY));
		}
		else {
